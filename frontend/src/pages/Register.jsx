      ...
      <div className="col-12 col-md-8 col-lg-6 fade-in-up">
        <div className="card glass-panel border border-opacity-10 p-4 p-md-5">
          ...
          <div className="text-center mb-4">
            <div
              className="d-inline-flex justify-content-center align-items-center bg-primary bg-opacity-10 text-primary rounded-circle mb-3"
            ...
            <p className="text-secondary small">
              Register to start filing or managing campus complaints
            </p>
          </div>
            ...
            <div className="mb-4">
              ...
              <div className="input-group">
                ...
                <input
                  ...
                  className="form-control custom-input border-start-0 text-white"
          ...
          <div className="text-center">
            ...
            <Link
              to="/login"
              className="text-primary fw-medium small text-decoration-none hover-underline"
            >
              Sign In Instead
            </Link>
          </div>
