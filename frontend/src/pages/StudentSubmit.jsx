        ...
        <div className="card glass-panel p-4 p-md-5">
          ...
          <p className="text-secondary mb-4">
            {isEditMode
              ...
              : 'Provide accurate details below to register your grievance. The administration will inspect it.'}
          </p>
          ...
          {(!isEditMode || (isEditMode && title)) && (
            <form onSubmit={handleSubmit}>
              ...
              {/* FIX: corrected 'boarder-top' layout spelling mistake */}
              <div className="d-flex justify-content-end gap-3 border-top border-opacity-10 pt-4" style={{ borderColor: 'var(--border-color)' }}>
